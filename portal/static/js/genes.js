...
function loadGeneData(geneData) {
    ...
    document.getElementById('gene-info-name').textContent = geneData.name || 'N/A';
    ...
    document.getElementById('gene-info-coords').textContent = `${startFormatted} - ${endFormatted}`;
    ...
    document.getElementById('gene-details-section').scrollIntoView({ behavior: 'smooth', block: 'start' });
