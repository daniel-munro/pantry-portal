...
var twasHybridGridOptions = {
  ...
  datasource: {
    getRows: function (params) {
      ...
      fetch(
        `/api/twas-hybrid?limit=${params.endRow - params.startRow}&offset=${
          params.startRow
...
const twasHybridGridApi = agGrid.createGrid(
  twasHybridGridDiv,
  twasHybridGridOptions
);
...
var twasDdpGridOptions = {
  ...
  datasource: {
    getRows: function (params) {
      ...
      fetch(
        `/api/twas-ddp?limit=${params.endRow - params.startRow}&offset=${
          params.startRow
        }${sortParams}${filterParams}`
      )
        .then((response) => response.json())
...
var qtlsHybridGridOptions = {
  ...
  datasource: {
    getRows: function (params) {
      ...
      fetch(
        `/api/qtls-hybrid?limit=${params.endRow - params.startRow}&offset=${
          params.startRow
        }${sortParams}${filterParams}`
      )
        .then((response) => response.json())
...
const qtlsHybridGridApi = agGrid.createGrid(
  qtlsHybridGridDiv,
  qtlsHybridGridOptions
);
...
var qtlsDdpGridOptions = {
  ...
  datasource: {
    getRows: function (params) {
      ...
      fetch(
        `/api/qtls-ddp?limit=${params.endRow - params.startRow}&offset=${
          params.startRow
        }${sortParams}${filterParams}`
      )
        .then((response) => response.json())
